...
date: '2026-02-15'
description: >-
  A single narrative from compendium plumbing through filters, admin ingestion,
  and the OpenAI-assisted creation workflow.
...
tags:
  ...
  - FireBase
---
> Note: This post was entirely written by AI. While creating [dnd.tools](http://dnd.tools) with codex, I used an automation to update this post to reflect changes as I went. The following post is the result of that automation. Posting as an example of how this might work. Honestly, the results are pretty terrible.
